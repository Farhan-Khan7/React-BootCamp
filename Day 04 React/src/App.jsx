...
import ProductCard from "./Component/Product.jsx";
...
const App = () => {
  ...
  return (
    <div className="w-full h-fit bg-gray-800 flex flex-wrap gap-10 items-center justify-center p-6">
      {products.map((item) => {
        return <ProductCard key={item.id} product={item} del={delt} />;
      })}
    </div>
  );
};
